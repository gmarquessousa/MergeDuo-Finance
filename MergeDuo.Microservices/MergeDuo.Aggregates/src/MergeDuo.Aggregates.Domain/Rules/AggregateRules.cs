...
namespace MergeDuo.Aggregates.Domain.Rules;
...
public readonly record struct YearMonth(int Year, int Month)
{
    ...
    public static YearMonth FromRoute(int year, int month)
    {
        ...
        {
            throw new AggregatesBadRequestException("invalid_year", "Invalid year.");
        }

        if (month is < 1 or > 12)
        {
            throw new AggregatesBadRequestException("invalid_month", "Invalid month.");
        }
    ...
    public static YearMonth Parse(string value)
    {
        ...
        {
            throw new AggregatesBadRequestException("invalid_year_month", "Invalid yearMonth.");
        }
