...
namespace MergeDuo.Aggregates.Domain.Contracts;
...
public sealed record YearAggregatesResponse(
    [property: JsonPropertyName("userId")] string UserId,
    [property: JsonPropertyName("year")] int Year,
    [property: JsonPropertyName("months")] IReadOnlyList<MonthlyAggregateResponse> Months);
